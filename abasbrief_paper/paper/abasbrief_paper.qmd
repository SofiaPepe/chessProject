...
Table 1 summarises the transition from the source database to the Raven-screened
analytic sample. Table 2 describes the nine baseline outcomes. The complete
...
![FDR-significant standardised coefficients from the primary age-adjusted models. Blue markers represent ABAS-II predictors and orange markers represent BRIEF-2 predictors.](../figures/primary_forest_plot.png){fig-alt="Forest plot of FDR-significant standardized regression coefficients with 95% confidence intervals." width=95%}

![Map of FDR-significant questionnaire–outcome associations. Blank cells did not survive correction within their prespecified family.](../figures/significant_beta_heatmap.png){fig-alt="Heatmap of standardized coefficients for significant ABAS-II and BRIEF-2 associations with visuospatial outcomes." width=95%}
